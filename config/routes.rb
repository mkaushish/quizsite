...
#  get '/student/notifications',               to: 'students#notifications', :as => :notifications_student
  ...
  get '/quiz/:quiz_id/finish',                     to: 'quiz_instances#finish_quiz',:as => :finish_quiz
  ...
  post '/quiz/:quiz_id/quiz_instances/:id/finish_problem',                to: 'quiz_instances#finish_problem', :as => :finish_quiz_problem

Quizsite::Application.routes.draw do
  ...
  get "/sample_problem/do/:id", :to => 'pages#do_sample_problem', :as => :do_sample_problem
  post "/sample_problem/finish/:id", :to => 'pages#finish_sample_problem', :as => :finish_sample_problem

...
function shelf_color_in(blue, green, red){
  if(green != "0"){
$('#bigshelf .shelf .shelf_ul').css("background","-webkit-gradient(linear,"+blue+" 0%,"+(red)+ " 0%, from(#0087bd), to(#ff0040), color-stop(.005,#60b349),color-stop(.995,#60b349))")
}
else{
    $('#bigshelf .shelf .shelf_ul').css("background","-webkit-linear-gradient(left,#0087bd "+blue+",#ff0040 "+blue); 
}
$('#bigshelf .shelf .shelf_ul').css("background","-moz-linear-gradient(0% 0% 0deg,#0087bd, #1414C9, #0087bd "+blue+",#60b349 0%,#60b349 "+red+",#ff0040 0%)");
}